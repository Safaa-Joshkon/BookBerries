...
<body>
    <nav class="navbar navbar-expand-sm bg-white sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.html" target="_blank"><img src="images/BookBerries-logo.png"
            ...
            <div class="collapse navbar-collapse" id="mynavbar">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="wishlist.html" target="_blank">
                            Wishlist <i class="fa fa-heart" aria-hidden="true"></i> </a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="signin.html" target="_blank">Sign-In</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="createAccount.html" target="_blank">Create an Account</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="cart.html" target="_blank"><i
            ...
            <div class="row d-flex ">
                ...
                <div class="col-md-8 col-lg-6 col-xl-5 offset-xl-1">
                    <form>
                        ...
                        <div>
                            <button type="submit" class="btn btn-primary btn-lg login">Login</button><br><br>
                            <p><b>Don't have an account?</b><a href="createAccount.html" target="_blank"
                                    class="link-danger"> Create an
                                    Account</a></p>
                        </div>
                    </form>
                </div>
